...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-4 relative">
            ...
            {/* Main Window */}
            <div className={`w-full max-w-2xl my-auto ${tc.bg} border ${tc.border} border-opacity-30 shadow-lg rounded-sm relative overflow-hidden backdrop-blur-md z-20 transition-colors duration-500`}>
